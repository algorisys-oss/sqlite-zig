...
int main(void) {
    ...
    ** sqliteInt.h (config-invariant, sizeof 144); src/window.zig mirrors it. */
    ...
    P(WhereInfo, pResultSet);
    P(WhereInfo, iContinue);
    P(WhereInfo, iBreak);
    P(WhereInfo, iTop);
    P(WhereInfo, iEndWhere);
    P(WhereInfo, iLimit);
    P(WhereInfo, nOBSat);
    P(WhereInfo, eDistinct);
    P(WhereInfo, nRowOut);
    P(WhereInfo, pLoops);
    P(WhereInfo, pMemToFree);
    P(WhereInfo, aiCurOnePass);
    SZ(WhereInfo, WhereInfo);
    P(WhereLevel, iLeftJoin);
    P(WhereLevel, iTabCur);
    P(WhereLevel, iIdxCur);
    P(WhereLevel, addrBrk);
    P(WhereLevel, addrHalt);
    P(WhereLevel, addrNxt);
    P(WhereLevel, addrSkip);
    P(WhereLevel, addrCont);
    P(WhereLevel, addrFirst);
    P(WhereLevel, addrBody);
    P(WhereLevel, regBignull);
    P(WhereLevel, addrBignull);
    P(WhereLevel, iLikeRepCntr);
    P(WhereLevel, addrLikeRep);
    P(WhereLevel, regFilter);
    P(WhereLevel, pRJ);
    P(WhereLevel, iFrom);
    P(WhereLevel, op);
    P(WhereLevel, p1);
    ...
    P(WhereLevel, u);
    P(WhereLevel, pWLoop);
    P(WhereLevel, notReady);
    printf("WhereLevel_u_in_nIn %zu\n", offsetof(struct WhereLevel, u.in.nIn));
    printf("WhereLevel_u_in_aInLoop %zu\n", offsetof(struct WhereLevel, u.in.aInLoop));
    printf("WhereLevel_u_pCoveringIdx %zu\n", offsetof(struct WhereLevel, u.pCoveringIdx));
    P(InLoop, iCur);
    P(InLoop, addrInTop);
    P(InLoop, iBase);
    P(InLoop, nPrefix);
    ...
    SZ(InLoop, InLoop);
    P(WhereLoop, iTab);
    P(WhereLoop, iSortIdx);
    P(WhereLoop, rSetup);
    P(WhereLoop, rRun);
    P(WhereLoop, maskSelf);
    P(WhereLoop, prereq);
    P(WhereLoop, u);
    P(WhereLoop, nLSlot);
    P(WhereLoop, pNextLoop);
    P(WhereLoop, aLTermSpace);
    SZ(WhereLoop, WhereLoop);
    printf("WhereLoop_u_btree_nDistinctCol %zu\n", offsetof(struct WhereLoop, u.btree.nDistinctCol));
    printf("WhereLoop_u_btree_pOrderBy %zu\n", offsetof(struct WhereLoop, u.btree.pOrderBy));
    printf("WhereLoop_u_vtab_isOrdered %zu\n", offsetof(struct WhereLoop, u.vtab.isOrdered));
#ifdef SQLITE_DEBUG
    P(WhereLoop, cId);
#endif
    P(WhereLoopBuilder, pWInfo);
    P(WhereLoopBuilder, pWC);
    P(WhereLoopBuilder, pNew);
    P(WhereLoopBuilder, pOrSet);
    P(WhereLoopBuilder, bldFlags1);
    P(WhereLoopBuilder, bldFlags2);
    P(WhereLoopBuilder, iPlanLimit);
    SZ(WhereLoopBuilder, WhereLoopBuilder);
    P(WhereScan, pOrigWC);
    P(WhereScan, pWC);
    P(WhereScan, zCollName);
    P(WhereScan, pIdxExpr);
    P(WhereScan, k);
    P(WhereScan, opMask);
    P(WhereScan, idxaff);
    P(WhereScan, iEquiv);
    P(WhereScan, nEquiv);
    P(WhereScan, aiCur);
    P(WhereScan, aiColumn);
    SZ(WhereScan, WhereScan);
    P(WherePath, maskLoop);
    P(WherePath, revLoop);
    P(WherePath, nRow);
    P(WherePath, rCost);
    P(WherePath, rUnsort);
    P(WherePath, isOrdered);
    P(WherePath, aLoop);
    SZ(WherePath, WherePath);
    P(WhereOrSet, n);
    P(WhereOrSet, a);
    SZ(WhereOrSet, WhereOrSet);
    P(WhereOrCost, prereq);
    P(WhereOrCost, rRun);
    P(WhereOrCost, nOut);
    SZ(WhereOrCost, WhereOrCost);
    P(WhereRightJoin, iMatch);
    P(WhereRightJoin, regBloom);
    P(WhereRightJoin, regReturn);
    P(WhereRightJoin, addrSubrtn);
    P(WhereRightJoin, endSubrtn);
    SZ(WhereRightJoin, WhereRightJoin);
    P(WhereMaskSet, n);
    P(WhereMaskSet, ix);
    SZ(WhereMaskSet, WhereMaskSet);
    P(WhereMemBlock, pNext);
    P(WhereMemBlock, sz);
    SZ(WhereMemBlock, WhereMemBlock);
    SZ(Index, Index);
    P(IndexedExpr, zIdxName);
    SZ(IndexedExpr, IndexedExpr);
    printf("SrcItem_u2_pCteUse %zu\n", offsetof(struct SrcItem, u2.pCteUse));
    printf("SrcItem_u2_pIBIndex %zu\n", offsetof(struct SrcItem, u2.pIBIndex));
    P(VTable, bAllSchemas);
    P(sqlite3_module, xBestIndex);
    P(sqlite3_vtab, zErrMsg);
    /* sqlite3_index_info + its 3 nested element structs */
    P(sqlite3_index_info, nConstraint);
    P(sqlite3_index_info, aConstraint);
    P(sqlite3_index_info, nOrderBy);
    P(sqlite3_index_info, aOrderBy);
    P(sqlite3_index_info, aConstraintUsage);
    P(sqlite3_index_info, idxNum);
    P(sqlite3_index_info, idxStr);
    P(sqlite3_index_info, needToFreeIdxStr);
    P(sqlite3_index_info, orderByConsumed);
    P(sqlite3_index_info, estimatedCost);
    P(sqlite3_index_info, estimatedRows);
    P(sqlite3_index_info, idxFlags);
    P(sqlite3_index_info, colUsed);
    SZ(sqlite3_index_info, sqlite3_index_info);
    printf("idxinfo_constraint_iColumn %zu\n", offsetof(struct sqlite3_index_constraint, iColumn));
    printf("idxinfo_constraint_op %zu\n", offsetof(struct sqlite3_index_constraint, op));
    printf("idxinfo_constraint_usable %zu\n", offsetof(struct sqlite3_index_constraint, usable));
    printf("idxinfo_constraint_iTermOffset %zu\n", offsetof(struct sqlite3_index_constraint, iTermOffset));
    printf("sizeof_idxinfo_constraint %zu\n", sizeof(struct sqlite3_index_constraint));
    printf("idxinfo_orderby_iColumn %zu\n", offsetof(struct sqlite3_index_orderby, iColumn));
    printf("idxinfo_orderby_desc %zu\n", offsetof(struct sqlite3_index_orderby, desc));
    printf("sizeof_idxinfo_orderby %zu\n", sizeof(struct sqlite3_index_orderby));
    printf("idxinfo_usage_argvIndex %zu\n", offsetof(struct sqlite3_index_constraint_usage, argvIndex));
    printf("idxinfo_usage_omit %zu\n", offsetof(struct sqlite3_index_constraint_usage, omit));
    printf("sizeof_idxinfo_usage %zu\n", sizeof(struct sqlite3_index_constraint_usage));
